...
/**
 * _printf - This is a PrintF Function custom made
 * @format: format specifiers ...
 * Return: Printed characters ... yes
 */
...
/**
 * print_buffer - Prints the contents of the buffer if it exist and check if it exits
